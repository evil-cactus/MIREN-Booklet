...
% Custom macro to sort and display CSV content
\newcommand{\sortCSV}[2]{
    % #1: Input CSV file
    % #2: Column index to sort by
    \pgfplotstablesort[col=#2]{\sortedtable}{#1} % Sorting
    \pgfplotstabletypeset{\sortedtable} % Displaying sorted table
}
